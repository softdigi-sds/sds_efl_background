...
table {
  ...
  <h2>8-2-601,Street No : 10, Banjara hills,HYDERABAD,Delhi-500034</h2>
      ...
      <div class="flex-container">
        ...
        <div><p style="text-align: left;">ACK No:112421792792326</p>
...
<?php
  ...
  public function generatePdf( $id, $data){  
    $location = InvoiceHelper::getFullFile($id);
    $html = $this->getHtml($data);
    // echo $html;
    // exit();
    SmartPdfHelper::genPdf($html, $location);
