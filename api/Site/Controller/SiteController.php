...
class SiteController extends BaseController{
    ...
    function __construct($params)
    {
        ...
        // 
        $this->_helper = new SiteHelper($this->db);
    }
